...
const anakau = {
video:fs.readFileSync("./baseikal/image/vilew.jpg"),
gifPlayback:true,
jpegThumbnail:log0,
caption:`Haii Kak ${pushname} Selamat ${salam} *Aku Adalah VilewBotz*
...
var order = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
	...
	"sellerJid": "6281255090574@s.whatsapp.net",
...
anjay(`Baiklah Tuan`)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./baseikal/image/duar.jpg') }, { upload: haikal.waUploadToServer })
...
"productImage": messa.imageMessage,
"productId": "449756950375071",
"title": `Vilew${ngazap(prefix)}`,
"description": `VilewNoCounter`,
"currencyCode": "IDR",
"footerText": `� VilewBotz`,
"productImageCount": 1,
"firstImageId": 1,
"retailerId": `Ayonima`,
"url": "wa.me/6281255090574"
},
"businessOwnerJid": "6281255090574@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: doc})
...
if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return anjay(`Contoh ${prefix+command} https://vm.tiktok.com/ZSR9ENPnQ/`)
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
if (!args[0]) return anjay(`*Example* : ${prefix}cowner add 628xxxx`)
if (args[1]) {
orgnye = args[1]
} else if (m.quoted) {
